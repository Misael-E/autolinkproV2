				...
				<Container style={container}>
					...
					<Section align="right">
						<Row>
							<Column style={tableCell} align="right">
								...
								<Text style={productPriceTotalLarge}>
									TOTAL
								</Text>
							</Column>
							<Column style={productPriceVerticalLine} />
							<Column style={productPriceLargeWrapper}>
								<Text style={productPriceMedium}>
									${totals?.subtotal ?? 0}
								</Text>
								<Text style={productPriceMedium}>
									${totals?.gst ?? 0}
                  ...
                  /> */}
					...
					<Text style={footerText}>
						...
						invoices@aztecautoglass.ca or by phone at 587-966-7636.
					</Text>
					<Text style={footerText}>
						...
						crack during or after the process. Aztec is not
					...
					<Text style={footerText}>
						Please call Aztec Auto Glass at 587-966-7636 with
						questions about the invoice or any other inquires.
					</Text>
