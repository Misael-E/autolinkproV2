			...
			<div className="flex justify-end px-5 py-3 border-b border-gray-700/60">
				{showNewRow ? (
					...
					<button
						...
						className="flex items-center gap-1.5 text-xs font-medium text-aztecBlue hover:text-blue-300 transition-colors">
					...
					{entries.length === 0 && !showNewRow && (
						<tr>
							<td
								...
								<span className="text-aztecBlue">Add Entry</span> to create one
								manually.
							</td>
						</tr>
					)}
