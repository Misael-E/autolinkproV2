...
const BigCalendar = ({ defaultView = Views.MONTH }: { defaultView?: View }) => {
  ...
  const handleOnNavigate = (
	...
	const quandrantColors: Record<string, string> = {
                    ...
                    <div className="flex flex-col min-w-0 flex-1">
                      ...
                      >
						{typedEvent.resource.quadrant && (
							<span className={`inline-block text-[10px] font-semibold tracking-wide ${quandrantColors[typedEvent.resource.quadrant] || "bg-gray-100 text-gray-800"} border border-current/40 rounded px-1.5 py-0.5 leading-none mt-0.5 w-fit`}>
							{typedEvent.resource.quadrant}
							</span>
