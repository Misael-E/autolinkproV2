      ...
      {total === 0 ? (
        ...
        <>
          <div className="flex items-center gap-2 mb-3">
            <div className="flex-1 bg-aztecBlack rounded-full h-3 overflow-hidden flex">
              <div
                className="h-3 bg-aztecGreen rounded-l-full"
                style={{ width: `${retentionPct}%` }}
              />
              <div
                className="h-3 bg-aztecBlue rounded-r-full"
                style={{ width: `${newPct}%` }}
              />
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <div className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-aztecGreen flex-shrink-0" />
              <div>
            ...
            <div className="flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-aztecBlue flex-shrink-0" />
              <div>
