        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.leftColumn}>
            <View style={styles.supplierInfo}>
              ...
              />
              <View>
                <Text style={styles.supplierInfoTitle}>Aztec Auto Glass Ltd</Text>
                <Text>203 - 2914 Kingsview Boulevard SE</Text>
                <Text>Airdrie AB T4A 0E1</Text>
                <Text>{formatPhoneNumber("5879667636")}</Text>
                <Text>GST/HST: 792765935RT0001</Text>
              </View>
            </View>
          </View>

          {/* Right Column: Title, Customer, Dates */}
...
export async function GET(
  request: Request,
  { params }: { params: { id: string; location: string } }
) {
