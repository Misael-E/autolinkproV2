...
const Email = ({
  ...
  return (
    <Html>
      ...
      <Body style={main}>
        <Preview>O Detail Invoice</Preview>
        <Container style={container}>
          ...
          <Section>
            {invoice?.services.map((service) => (
              <Row key={service.id} style={{ paddingBottom: "12px" }}>
                <Column
                  style={{
                    paddingLeft: "22px",
                    width: "60%",
          ...
          <Text style={footerText}>
            1. You can contact us via email at invoices@odetail.ca or by phone
            at 587-966-7636.
          </Text>
          <Text style={footerText}>
          ...
          <Text style={footerText}>
            Please call O Detail at 587-966-7636 with questions about the
            invoice or any other inquires.
          </Text>
