  ...
  return (
    <div className="bg-odetailBlack-dark rounded-xl p-5 flex flex-col gap-3 flex-1">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className={`text-2xl font-bold ${rate >= 60 ? "text-odetailGreen" : rate >= 30 ? "text-odetailOrange" : "text-red-400"}`}>
            {rate}%
          </p>
      ...
      <div className="mt-auto pt-2 border-t border-odetailBlack-light">
