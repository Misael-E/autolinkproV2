...
const InvoiceForm = ({
	...
	const customerType = useWatch({
		control,
		name: "customerType",
		defaultValue: CustomerTypeEnum.Retailer,
	});
									...
									<div
										...
										<div className="flex flex-col min-w-0">
											...
											<span className="text-gray-400 truncate">
												{service.code} · x{service.quantity} · ${service.price}
											</span>
										</div>
										<div className="flex items-center gap-2 shrink-0 ml-2">
											<button
												...
												<FontAwesomeIcon
													icon={faPencil}
													className="text-gray-400 hover:text-white w-3 h-3 transition-colors"
												/>
											</button>
											<button
												type="button"
												...
												<FontAwesomeIcon
													icon={faClose}
													className="text-gray-400 hover:text-red-400 w-3 h-3 transition-colors"
												/>
											</button>
										</div>
									</div>
