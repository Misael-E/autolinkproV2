...
const OutstandingReceivables = async () => {
  ...
  return (
    <div className="bg-odetailBlack-dark rounded-xl p-5 flex flex-col gap-3 flex-1">
      ...
      <p className={`text-2xl font-bold ${total > 0 ? "text-red-400" : "text-odetailGreen"}`}>
        ${fmt(total)}
      </p>

      <div className="flex flex-col gap-2">
        <div className="flex justify-between text-xs">
          <span className="text-odetailOrange font-medium">Pending</span>
      ...
      <div className="w-full bg-odetailBlack rounded-full h-1.5 overflow-hidden mt-auto">
        <div
